...
execute_process(
  COMMAND "F:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "v6.7.0"
  WORKING_DIRECTORY "E:/CODE/FDS/fds/Build/_deps/sundials-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v6.7.0" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: v6.7.0")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/v6.7.0")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v6.7.0\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/CODE/FDS/fds/Build/_deps/sundials-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/CODE/FDS/fds/Build/_deps/sundials-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
